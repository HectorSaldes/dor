			...
			>
				<div className='container glassmorphism pb-2'>
					<div className='w-full flex py-6 px-4 md:px-8 justify-between items-center'>
						...
						<a href={notionPage} target='_blank' rel='noreferrer'>
					...
					<div className='w-full sm:w-5/6 mx-auto'>
						<div className='relative flex flex-wrap justify-center'>
							<CardCartoonOutlined
								Items={() => <ImageTop url={profile} alt='Image profile' />}
							/>
							<CardCartoonOutlined
								Items={() => <ImageTop url={notion} alt='Image notion' />}
							/>
						</div>
						...
						<div className='my-7 grid grid-cols-1 md:grid-cols-2 gap-10'>
							<div className='w-full'>
								<CardCartoonOutlined
									Items={() => (
										<TextDetails title='Como yo te veo' description={seeYou} />
									)}
								/>
							</div>
							<div className='w-full'>
									...
									<>
										...
										<div className='grid grid-cols-1 md:grid-cols-3 gap-10'>
											{senseYou.map((sense, i) => (
												<div key={i}>
													<CardSense url={sense.cover} text={sense.text} />
												</div>
											))}
										</div>
									</>
